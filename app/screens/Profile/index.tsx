...
import { appTheme, URL } from "../../constants";
...
export function Profile({ navigation }) {
  ...
  const thumbnail = `${URL}${state.me.data.me.avatar}`;
        ...
        <View>
          <View style={styles.profileDetailsSection}>
            ...
            <View style={styles.profileCenterSection}>
              <Text style={styles.nameText}>{state.me.data.me.username}</Text>
              <Text style={styles.designationText}>{state.me.data.me.bio}</Text>
              <TouchableOpacity
