...
exports.default = {
    Mutation: {
        editUser: function (_, args, _a) {
            var request = _a.request, prisma = _a.prisma;
            return __awaiter(void 0, void 0, void 0, function () {
                var username, email, firstName, lastName, bio, avatar, user;
                return __generator(this, function (_b) {
                    ...
                    return [2 /*return*/, prisma.user.update({
                            where: { id: user.id },
                            data: { username: username, email: email, firstName: firstName, lastName: lastName, bio: bio, avatar: avatar },
                        })];
                });
            });
        },
