...
exports.default = {
    Mutation: {
        signupUser: function (_, args, _a) {
            var prisma = _a.prisma;
            return __awaiter(void 0, void 0, void 0, function () {
                var username, password, email, _b, firstName, _c, lastName, _d, bio, existingUser, passwordHash, user, token;
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            username = args.username, password = args.password, email = args.email, _b = args.firstName, firstName = _b === void 0 ? "" : _b, _c = args.lastName, lastName = _c === void 0 ? "" : _c, _d = args.bio, bio = _d === void 0 ? "" : _d;
